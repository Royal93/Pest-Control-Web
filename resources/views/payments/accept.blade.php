...
@section('title', 'Payment Successful — SP Pest Control')

@section('content')
<section class="max-w-md mx-auto px-7 py-24 text-center">
    <h1 class="font-display uppercase text-2xl mb-3">Payment Successful</h1>
    <p class="text-inkMuted mb-2">Thank you — your payment has been received.</p>
    @if ($payment)
